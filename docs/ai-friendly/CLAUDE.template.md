...
# Instructions for Claude (copy this file to the root of your mod)

> Copy this file to the root of your mod, renaming it to
> `CLAUDE.md`. Claude Code reads it automatically on startup.
